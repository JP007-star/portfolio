            ...
            <div className="flex flex-wrap gap-2.5 mb-10">
              {allSkills.map((skill, index) => (
                <motion.span
                  ...
                  className="px-4 py-2 bg-zinc-800/60 border border-zinc-700/60 rounded-lg text-zinc-300 hover:border-indigo-500/50 hover:text-indigo-300 hover:bg-indigo-500/10 transition-all cursor-default text-sm"
                >
                  {skill.name}
                </motion.span>
              ))}
